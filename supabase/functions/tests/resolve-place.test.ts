...
const doppler: Candidate = { provider: "google", providerId: "g1", name: "Doppler Coffee", address: "C-Scheme, Jaipur, Rajasthan 302001, India", locality: null, lat: 26.91, lng: 75.79, category: "cafe", hours: null, status: "OPERATIONAL", url: null };
