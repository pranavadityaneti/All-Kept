  ...
  return (
    ...
    >
      ...
      <View pointerEvents="none" style={styles.copy}>
        <Text numberOfLines={2} adjustsFontSizeToFit minimumFontScale={0.86} style={styles.name}>{label}</Text>
...
const styles = StyleSheet.create({
  ...
  scrimTop: { position: "absolute", left: 0, right: 0, bottom: 45, height: 26, backgroundColor: "rgba(255,255,255,0.34)" },
  scrimBottom: { position: "absolute", left: 0, right: 0, bottom: 0, height: 46, backgroundColor: "rgba(255,255,255,0.76)" },
  copy: { position: "absolute", left: space.md, right: space.sm, bottom: space.sm, gap: 1 },
  name: { color: "#17131D", fontSize: 14, lineHeight: 15, fontWeight: "700", letterSpacing: -0.25 },
  count: { color: "rgba(23,19,29,0.66)", fontSize: 11, lineHeight: 13, fontWeight: "500" },
});
